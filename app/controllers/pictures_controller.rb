class PicturesController < ApplicationController
	...
	def configure_instagram
		Instagram.configure do |config|
			config.client_id = ENV["_FIGARO_instagram_client_id"] || ENV["instagram_client_id"]
			config.client_secret = ENV["_FIGARO_instagram_client_secret"] || ENV["instagram_client_secret"]
